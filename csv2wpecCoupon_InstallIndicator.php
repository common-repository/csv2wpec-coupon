...
include_once('csv2wpecCoupon_OptionsManager.php');

class csv2wpecCoupon_InstallIndicator extends csv2wpecCoupon_OptionsManager {
     ...
     * compared using version_compare
     * @return null
     */
