...
class csv2wpecCoupon_OptionsManager {
    ...
    public function settingsPage() {
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'csv2wpec-coupon'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'csv2wpec-coupon'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'csv2wpec-coupon'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'csv2wpec-coupon');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'csv2wpec-coupon'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'csv2wpec-coupon');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'csv2wpec-coupon'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'csv2wpec-coupon') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'csv2wpec-coupon');
            case 'false':
                return __('false', 'csv2wpec-coupon');

            case 'Administrator':
                return __('Administrator', 'csv2wpec-coupon');
            case 'Editor':
                return __('Editor', 'csv2wpec-coupon');
            case 'Author':
                return __('Author', 'csv2wpec-coupon');
            case 'Contributor':
                return __('Contributor', 'csv2wpec-coupon');
            case 'Subscriber':
                return __('Subscriber', 'csv2wpec-coupon');
            case 'Anyone':
                return __('Anyone', 'csv2wpec-coupon');
        }
        return $optionValue;
    }
